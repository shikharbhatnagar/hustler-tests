...
const { getAllProducts, getProductDetails, updateProduct, deleteProduct, getProductReviews, deleteReview, createProductReview, createProduct, getAdminProducts, getProducts, getAllProductsx, getProductById, getProductsByCategory } = require('../controllers/productController');
...
// New API Routes Added By Shikhar
router.get("/products", getAllProductsx);
